...
/home/bart/.ghcup/ghc/8.10.7/bin/hpc markup coverage-report-0.1.0.0-ab.tix \
                                            --destdir=html/test-a \
                                            --hpcdir=dist-newstyle/build/x86_64-linux/ghc-8.10.7/coverage-report-0.1.0.0/hpc/vanilla/mix/test-a-test \
...
#                           -fhpc \
#                           -hpcdir /home/bart/engineering/iog/coverage-report/dist-newstyle/build/x86_64-linux/ghc-8.10.7/coverage-report-0.1.0.0/hpc/vanilla/mix/test-b-test \
